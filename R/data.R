...
#' @describeIn objects
#'   A simulated clustering data set generated
#'   to contain **3 true clusters** in bivariate space.
#'   There are 2 features, named "F1" and "F2" and 150 observations.
#'
