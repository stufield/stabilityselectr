...
- [`stability_selection()`](https://stufield.github.io/stabilityselectr/reference/stability_selection.md)
  ...
  [`print(`*`<stab_sel>`*`)`](https://stufield.github.io/stabilityselectr/reference/stability_selection.md)
  [`summary(`*`<stab_sel>`*`)`](https://stufield.github.io/stabilityselectr/reference/stability_selection.md)
  [`plot(`*`<stab_sel>`*`)`](https://stufield.github.io/stabilityselectr/reference/stability_selection.md)
  : Stability Selection

## Calculating FDR

Calculate the empirical false discovery rates (FDR) via permutations of
...
- [`progeny_cluster()`](https://stufield.github.io/stabilityselectr/reference/progeny_cluster.md)
  [`is_pclust()`](https://stufield.github.io/stabilityselectr/reference/progeny_cluster.md)
  [`plot(`*`<pclust>`*`)`](https://stufield.github.io/stabilityselectr/reference/progeny_cluster.md)
  [`print(`*`<pclust>`*`)`](https://stufield.github.io/stabilityselectr/reference/progeny_cluster.md)
...
- [`clust_data`](https://stufield.github.io/stabilityselectr/reference/objects.md)
  [`progeny_data`](https://stufield.github.io/stabilityselectr/reference/objects.md)
  : Package Objects
