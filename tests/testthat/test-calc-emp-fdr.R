...
fdr    <- calc_emp_fdr(ss_perm10, thresh_seq = pi_vec)
...
# Threshold 1 value ----
test_that("`calc_emp_fdr()` returns correct values when thresh is 1 value", {
  pi75 <- calc_emp_fdr(ss_perm10, thresh_seq = 0.75)
